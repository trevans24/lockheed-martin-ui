    ...
    return (
      <section className="home">
        ...
        <div className="header text-center">
          ...
          <img src={require("../../src/assets/img/Lockheed_Martin.svg")} alt="lockheed-martin-logo" />
        </div>
        ...
        <div className="code-info">
          ...
          <div className="code-grid">
            <div className="react">
              <img src={require('../../src/assets/img/React.svg')} alt="react-js" />
            ...
            <div className="sass">
              <img src={require('../../src/assets/img/sass.svg')} alt="sass" />
            ...
            <div className="webpack">
              <img src={require('../../src/assets/img/webpack.svg')} alt="webpack" />
        ...
        <div className="contact">
          {/* Spire Logo */}
          <img src={require("../../src/assets/img/spire-logo.svg")} alt="spire-digital-logo" className="spire" />
